...
<template>
  <div>
    ...
    <div class="board-wrapper">
      ...
      <div class="board">
        <div class="row">
          <div v-for="num in rowThree" class="space" @click="console.log(num)">
            {{ num }}
          </div>
        </div>
        <div class="row">
          <div v-for="num in rowTwo" class="space" @click="console.log(num)">
            {{ num }}
          </div>
        </div>
        <div class="row">
          <div v-for="num in rowOne" class="space" @click="console.log(num)">
            {{ num }}
          </div>
        </div>
